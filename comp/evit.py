...
class EViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', keep_rate=(1, ), fuse_token=True, **kwargs):
        """
        Args:
        ...
        # self._freeze_stages()
        # print(f'frozen stages are {self.frozen_stages}')
    ...
    def forward(self, x, keep_rate=None, tokens=None, get_idx=False, epoch=None):
