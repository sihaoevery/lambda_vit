...
#--------------------- model --------------------#
@register_model
def deit_tiny_patch16_224_copy_lambda(pretrained=False, **kwargs):
...
@register_model
def deit_small_patch16_224_copy_lambda(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def deit_base_patch16_224_copy_lambda(pretrained=False, **kwargs):
    model = VisionTransformer(
