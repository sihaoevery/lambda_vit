...
import models, models_shrink
from comp import evo_deit, evit, dynamic_vit
import tome, DiffRate
has_apex = False
try:
...
class BenchmarkRunner:
    def __init__(
        ...
        # self.model = evit.deit_base_patch16_shrink_base()
        # self.model = dynamic_vit.dynamic_deit_base_patch16_224_token_merge_softmax_reweight()

        # self.model = models.deit_base_patch16_224()
        self.model = models_shrink.deit_base_patch16_224_shrink(prune_layer=[],done_layer=[0,1,3,4,6])
        # self.model = models_shrink.deit_base_patch16_224_shrink(prune_layer=[],done_layer=[0,1,3,4,6,9])

        ### Small
        # self.model = evo_deit.evo_deit_small_patch16_224()
        # self.model = evit.deit_small_patch16_shrink_base()
        # self.model = dynamic_vit.dynamic_deit_small_patch16_224()
        # self.model = dynamic_vit.dynamic_deit_small_patch16_224_token_merge_softmax_reweight()

        # self.model = models.deit_small_patch16_224()
        # self.model = models_shrink.deit_small_patch16_224_shrink(prune_layer=[],done_layer=[0,2,4]) 
        # self.model = models_shrink.deit_small_patch16_224_shrink(prune_layer=[],done_layer=[0,2,4,6])

        ### Tiny
        # self.model = evo_deit.evo_deit_tiny_patch16_224()
        # self.model = evit.deit_tiny_patch16_shrink_base()
        # self.model = dynamic_vit.dynamic_deit_tiny_patch16_224()
        # self.model = dynamic_vit.dynamic_deit_tiny_patch16_224_token_merge_softmax_reweight()

        # self.model = models.deit_tiny_patch16_224()
        # self.model = models_shrink.deit_tiny_patch16_224_shrink(prune_layer=[],done_layer=[0,2,4])
        # self.model = models_shrink.deit_tiny_patch16_224_shrink(prune_layer=[],done_layer=[0,2,4,6])

        ###### ToMe Setting
        # tome.patch.timm(self.model,start_idx=1) # deit-base, remove [0,1,3,4,6]
        # self.model.r = 24 # or 28

        # tome.patch.timm(self.model,start_idx=0) # deit-base, remove [0,1,3,4,6,9]
        # self.model.r = 14

        # tome.patch.timm(self.model,start_idx=1) # deit-small, remove [0,2,4]
        # self.model.r = 22

        # tome.patch.timm(self.model,start_idx=1) # deit-small, remove [0,2,4,6]
        # self.model.r = 19

        # tome.patch.timm(self.model,start_idx=1) # deit-tiny, remove [0,2,4]
        # self.model.r = 19

        # tome.patch.timm(self.model,start_idx=1) # deit-tiny, remove [0,2,4,6]
        # self.model.r = 14


        ##### DiffRate
        # DiffRate.patch.deit(self.model, prune_granularity=4, merge_granularity=4)
        # model_name_dict = {
        ...
        #         self.model.set_kept_num(prune_kept_num, merge_kept_num)
